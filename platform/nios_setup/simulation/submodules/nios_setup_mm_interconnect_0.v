...
// 
// Generated using ACDS version 14.1 186 at 2015.09.03.15:25:16
...
module nios_setup_mm_interconnect_0 (
		...
		output wire [2:0]  led_io_s1_address,                              //                                led_io_s1.address
		...
		output wire [2:0]  one_sec_timer_s1_address,                       //                         one_sec_timer_s1.address
		output wire        one_sec_timer_s1_write,                         //                                         .write
		input  wire [15:0] one_sec_timer_s1_readdata,                      //                                         .readdata
		output wire [15:0] one_sec_timer_s1_writedata,                     //                                         .writedata
		output wire        one_sec_timer_s1_chipselect,                    //                                         .chipselect
		output wire [1:0]  sw_io_s1_address,                               //                                 sw_io_s1.address
		output wire        sw_io_s1_write,                                 //                                         .write
		input  wire [31:0] sw_io_s1_readdata,                              //                                         .readdata
		output wire [31:0] sw_io_s1_writedata,                             //                                         .writedata
		output wire        sw_io_s1_chipselect                             //                                         .chipselect
	);
	...
	wire  [16:0] sw_io_s1_agent_m0_address;                                                          // sw_io_s1_agent:m0_address -> sw_io_s1_translator:uav_address
	...
	wire  [93:0] sw_io_s1_agent_rf_source_data;                                                      // sw_io_s1_agent:rf_source_data -> sw_io_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] sw_io_s1_agent_rsp_fifo_out_data;                                                   // sw_io_s1_agent_rsp_fifo:out_data -> sw_io_s1_agent:rf_sink_data
	...
	wire         sw_io_s1_agent_rdata_fifo_src_valid;                                                // sw_io_s1_agent:rdata_fifo_src_valid -> sw_io_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] sw_io_s1_agent_rdata_fifo_src_data;                                                 // sw_io_s1_agent:rdata_fifo_src_data -> sw_io_s1_agent:rdata_fifo_sink_data
	wire         sw_io_s1_agent_rdata_fifo_src_ready;                                                // sw_io_s1_agent:rdata_fifo_sink_ready -> sw_io_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> sw_io_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sw_io_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // sw_io_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sw_io_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> sw_io_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> sw_io_s1_agent:cp_endofpacket
	...
	wire  [16:0] led_io_s1_agent_m0_address;                                                         // led_io_s1_agent:m0_address -> led_io_s1_translator:uav_address
	...
	wire  [93:0] led_io_s1_agent_rf_source_data;                                                     // led_io_s1_agent:rf_source_data -> led_io_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] led_io_s1_agent_rsp_fifo_out_data;                                                  // led_io_s1_agent_rsp_fifo:out_data -> led_io_s1_agent:rf_sink_data
	...
	wire         led_io_s1_agent_rdata_fifo_src_valid;                                               // led_io_s1_agent:rdata_fifo_src_valid -> led_io_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] led_io_s1_agent_rdata_fifo_src_data;                                                // led_io_s1_agent:rdata_fifo_src_data -> led_io_s1_agent:rdata_fifo_sink_data
	wire         led_io_s1_agent_rdata_fifo_src_ready;                                               // led_io_s1_agent:rdata_fifo_sink_ready -> led_io_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> led_io_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_io_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // led_io_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> led_io_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> led_io_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> led_io_s1_agent:cp_endofpacket
	wire  [31:0] one_sec_timer_s1_agent_m0_readdata;                                                 // one_sec_timer_s1_translator:uav_readdata -> one_sec_timer_s1_agent:m0_readdata
	wire         one_sec_timer_s1_agent_m0_waitrequest;                                              // one_sec_timer_s1_translator:uav_waitrequest -> one_sec_timer_s1_agent:m0_waitrequest
	wire         one_sec_timer_s1_agent_m0_debugaccess;                                              // one_sec_timer_s1_agent:m0_debugaccess -> one_sec_timer_s1_translator:uav_debugaccess
	wire  [16:0] one_sec_timer_s1_agent_m0_address;                                                  // one_sec_timer_s1_agent:m0_address -> one_sec_timer_s1_translator:uav_address
	wire   [3:0] one_sec_timer_s1_agent_m0_byteenable;                                               // one_sec_timer_s1_agent:m0_byteenable -> one_sec_timer_s1_translator:uav_byteenable
	wire         one_sec_timer_s1_agent_m0_read;                                                     // one_sec_timer_s1_agent:m0_read -> one_sec_timer_s1_translator:uav_read
	wire         one_sec_timer_s1_agent_m0_readdatavalid;                                            // one_sec_timer_s1_translator:uav_readdatavalid -> one_sec_timer_s1_agent:m0_readdatavalid
	wire         one_sec_timer_s1_agent_m0_lock;                                                     // one_sec_timer_s1_agent:m0_lock -> one_sec_timer_s1_translator:uav_lock
	wire  [31:0] one_sec_timer_s1_agent_m0_writedata;                                                // one_sec_timer_s1_agent:m0_writedata -> one_sec_timer_s1_translator:uav_writedata
	wire         one_sec_timer_s1_agent_m0_write;                                                    // one_sec_timer_s1_agent:m0_write -> one_sec_timer_s1_translator:uav_write
	wire   [2:0] one_sec_timer_s1_agent_m0_burstcount;                                               // one_sec_timer_s1_agent:m0_burstcount -> one_sec_timer_s1_translator:uav_burstcount
	wire         one_sec_timer_s1_agent_rf_source_valid;                                             // one_sec_timer_s1_agent:rf_source_valid -> one_sec_timer_s1_agent_rsp_fifo:in_valid
	wire  [93:0] one_sec_timer_s1_agent_rf_source_data;                                              // one_sec_timer_s1_agent:rf_source_data -> one_sec_timer_s1_agent_rsp_fifo:in_data
	wire         one_sec_timer_s1_agent_rf_source_ready;                                             // one_sec_timer_s1_agent_rsp_fifo:in_ready -> one_sec_timer_s1_agent:rf_source_ready
	wire         one_sec_timer_s1_agent_rf_source_startofpacket;                                     // one_sec_timer_s1_agent:rf_source_startofpacket -> one_sec_timer_s1_agent_rsp_fifo:in_startofpacket
	wire         one_sec_timer_s1_agent_rf_source_endofpacket;                                       // one_sec_timer_s1_agent:rf_source_endofpacket -> one_sec_timer_s1_agent_rsp_fifo:in_endofpacket
	wire         one_sec_timer_s1_agent_rsp_fifo_out_valid;                                          // one_sec_timer_s1_agent_rsp_fifo:out_valid -> one_sec_timer_s1_agent:rf_sink_valid
	wire  [93:0] one_sec_timer_s1_agent_rsp_fifo_out_data;                                           // one_sec_timer_s1_agent_rsp_fifo:out_data -> one_sec_timer_s1_agent:rf_sink_data
	wire         one_sec_timer_s1_agent_rsp_fifo_out_ready;                                          // one_sec_timer_s1_agent:rf_sink_ready -> one_sec_timer_s1_agent_rsp_fifo:out_ready
	wire         one_sec_timer_s1_agent_rsp_fifo_out_startofpacket;                                  // one_sec_timer_s1_agent_rsp_fifo:out_startofpacket -> one_sec_timer_s1_agent:rf_sink_startofpacket
	wire         one_sec_timer_s1_agent_rsp_fifo_out_endofpacket;                                    // one_sec_timer_s1_agent_rsp_fifo:out_endofpacket -> one_sec_timer_s1_agent:rf_sink_endofpacket
	wire         one_sec_timer_s1_agent_rdata_fifo_src_valid;                                        // one_sec_timer_s1_agent:rdata_fifo_src_valid -> one_sec_timer_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] one_sec_timer_s1_agent_rdata_fifo_src_data;                                         // one_sec_timer_s1_agent:rdata_fifo_src_data -> one_sec_timer_s1_agent:rdata_fifo_sink_data
	wire         one_sec_timer_s1_agent_rdata_fifo_src_ready;                                        // one_sec_timer_s1_agent:rdata_fifo_sink_ready -> one_sec_timer_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> one_sec_timer_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> one_sec_timer_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // one_sec_timer_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> one_sec_timer_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> one_sec_timer_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> one_sec_timer_s1_agent:cp_endofpacket
	...
	wire  [16:0] modular_adc_0_sample_store_csr_agent_m0_address;                                    // modular_adc_0_sample_store_csr_agent:m0_address -> modular_adc_0_sample_store_csr_translator:uav_address
	...
	wire  [93:0] modular_adc_0_sample_store_csr_agent_rf_source_data;                                // modular_adc_0_sample_store_csr_agent:rf_source_data -> modular_adc_0_sample_store_csr_agent_rsp_fifo:in_data
	...
	wire  [93:0] modular_adc_0_sample_store_csr_agent_rsp_fifo_out_data;                             // modular_adc_0_sample_store_csr_agent_rsp_fifo:out_data -> modular_adc_0_sample_store_csr_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> modular_adc_0_sample_store_csr_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // modular_adc_0_sample_store_csr_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> modular_adc_0_sample_store_csr_agent:cp_channel
	...
	wire  [16:0] modular_adc_0_sequencer_csr_agent_m0_address;                                       // modular_adc_0_sequencer_csr_agent:m0_address -> modular_adc_0_sequencer_csr_translator:uav_address
	...
	wire  [93:0] modular_adc_0_sequencer_csr_agent_rf_source_data;                                   // modular_adc_0_sequencer_csr_agent:rf_source_data -> modular_adc_0_sequencer_csr_agent_rsp_fifo:in_data
	...
	wire  [93:0] modular_adc_0_sequencer_csr_agent_rsp_fifo_out_data;                                // modular_adc_0_sequencer_csr_agent_rsp_fifo:out_data -> modular_adc_0_sequencer_csr_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> modular_adc_0_sequencer_csr_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // modular_adc_0_sequencer_csr_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> modular_adc_0_sequencer_csr_agent:cp_channel
	...
	wire         sw_io_s1_agent_rp_valid;                                                            // sw_io_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] sw_io_s1_agent_rp_data;                                                             // sw_io_s1_agent:rp_data -> router_005:sink_data
	wire         sw_io_s1_agent_rp_ready;                                                            // router_005:sink_ready -> sw_io_s1_agent:rp_ready
	wire         sw_io_s1_agent_rp_startofpacket;                                                    // sw_io_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         sw_io_s1_agent_rp_endofpacket;                                                      // sw_io_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         led_io_s1_agent_rp_valid;                                                           // led_io_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] led_io_s1_agent_rp_data;                                                            // led_io_s1_agent:rp_data -> router_006:sink_data
	wire         led_io_s1_agent_rp_ready;                                                           // router_006:sink_ready -> led_io_s1_agent:rp_ready
	wire         led_io_s1_agent_rp_startofpacket;                                                   // led_io_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         led_io_s1_agent_rp_endofpacket;                                                     // led_io_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         one_sec_timer_s1_agent_rp_valid;                                                    // one_sec_timer_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] one_sec_timer_s1_agent_rp_data;                                                     // one_sec_timer_s1_agent:rp_data -> router_007:sink_data
	wire         one_sec_timer_s1_agent_rp_ready;                                                    // router_007:sink_ready -> one_sec_timer_s1_agent:rp_ready
	wire         one_sec_timer_s1_agent_rp_startofpacket;                                            // one_sec_timer_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         one_sec_timer_s1_agent_rp_endofpacket;                                              // one_sec_timer_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [92:0] modular_adc_0_sample_store_csr_agent_rp_data;                                       // modular_adc_0_sample_store_csr_agent:rp_data -> router_008:sink_data
	...
	wire         modular_adc_0_sequencer_csr_agent_rp_valid;                                         // modular_adc_0_sequencer_csr_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] modular_adc_0_sequencer_csr_agent_rp_data;                                          // modular_adc_0_sequencer_csr_agent:rp_data -> router_009:sink_data
	wire         modular_adc_0_sequencer_csr_agent_rp_ready;                                         // router_009:sink_ready -> modular_adc_0_sequencer_csr_agent:rp_ready
	wire         modular_adc_0_sequencer_csr_agent_rp_startofpacket;                                 // modular_adc_0_sequencer_csr_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         modular_adc_0_sequencer_csr_agent_rp_endofpacket;                                   // modular_adc_0_sequencer_csr_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (sw_io_s1_write),                                 //                         .write
		.av_readdata            (sw_io_s1_readdata),                              //                         .readdata
		.av_writedata           (sw_io_s1_writedata),                             //                         .writedata
		.av_chipselect          (sw_io_s1_chipselect),                            //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) one_sec_timer_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (one_sec_timer_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (one_sec_timer_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (one_sec_timer_s1_agent_m0_read),                 //                         .read
		.uav_write              (one_sec_timer_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (one_sec_timer_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (one_sec_timer_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (one_sec_timer_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (one_sec_timer_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (one_sec_timer_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (one_sec_timer_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (one_sec_timer_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (one_sec_timer_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (one_sec_timer_s1_write),                         //                         .write
		.av_readdata            (one_sec_timer_s1_readdata),                      //                         .readdata
		.av_writedata           (one_sec_timer_s1_writedata),                     //                         .writedata
		.av_chipselect          (one_sec_timer_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (sw_io_s1_agent_rdata_fifo_src_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (sw_io_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_sink_data    (sw_io_s1_agent_rdata_fifo_src_data),             //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (led_io_s1_agent_rdata_fifo_src_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (led_io_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_sink_data    (led_io_s1_agent_rdata_fifo_src_data),            //                .data
	...
	altera_merlin_slave_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) one_sec_timer_s1_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (one_sec_timer_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (one_sec_timer_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (one_sec_timer_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (one_sec_timer_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (one_sec_timer_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (one_sec_timer_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (one_sec_timer_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (one_sec_timer_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (one_sec_timer_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (one_sec_timer_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (one_sec_timer_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (one_sec_timer_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (one_sec_timer_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (one_sec_timer_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (one_sec_timer_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (one_sec_timer_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (one_sec_timer_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (one_sec_timer_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (one_sec_timer_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (one_sec_timer_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (one_sec_timer_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (one_sec_timer_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (one_sec_timer_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (one_sec_timer_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (one_sec_timer_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (one_sec_timer_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (one_sec_timer_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (one_sec_timer_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (one_sec_timer_s1_agent_rdata_fifo_src_data),        //                .data
		.rdata_fifo_src_ready    (one_sec_timer_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (one_sec_timer_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (one_sec_timer_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) one_sec_timer_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (one_sec_timer_s1_agent_rf_source_data),             //        in.data
		.in_valid          (one_sec_timer_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (one_sec_timer_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (one_sec_timer_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (one_sec_timer_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (one_sec_timer_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (one_sec_timer_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (one_sec_timer_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (one_sec_timer_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (one_sec_timer_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	nios_setup_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (one_sec_timer_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (one_sec_timer_s1_agent_rp_valid),                //          .valid
		.sink_data          (one_sec_timer_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (one_sec_timer_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (one_sec_timer_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
